...
import { Fingerprint, CheckCircle2, Loader2, KeyRound, ShieldCheck, Link as LinkIcon, AlertCircle, Copy } from 'lucide-react';
...
function ProgressStep({ isActive, isCompleted, title, description }) {
  return (
